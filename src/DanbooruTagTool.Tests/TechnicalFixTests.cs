...
public class TechnicalFixTests(ITestOutputHelper output)
{
    ...
    [ProductionFact] public void ProductionExamplesAndAcceptedInputIsolation()
    {
        ...
        {
            "data/special2788/product_fit_verdicts.csv", AcceptedAssetImporter.PromotionRelativePath, "docs/issue56/rollout/issue56_ui_genre_taxonomy_v1.json",
        ...
        Assert.Equal(33612, after.Entries.Length); Assert.Equal(2983, after.Entries.Count(e => e.IsSpecial));
