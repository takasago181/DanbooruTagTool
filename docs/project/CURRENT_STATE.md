...
- **Issue #117 unified General/Special discovery + frozen #118 content-intent implementation is DEV-complete and validated on feature branch `codex/issue117-unified-browse-content-intent`, Draft PR #125, but is NOT merged to main yet.** Validated source checkpoint `47a263ed05800fc47c3a29c5867172ab8700c3a9`; GitHub Actions run `35312382053`: Release build PASS, full Release tests 178 total / 171 passed / 7 skipped / 0 failed, focused #117 13/13 PASS, diff-check PASS. Stop before merge; live main still reflects the pre-#117 browse UI until review/merge.
