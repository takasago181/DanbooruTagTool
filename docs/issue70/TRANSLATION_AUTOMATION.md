...
- Validated completed chunks: 186 / 186
- Validated completed rows: 92,739 / 92,739
- Current status totals: `ACCEPTED_AI` 79,518; `REVIEW_REQUIRED` 13,221
- Remaining rows: 0 (all chunks complete; next chunk none)
