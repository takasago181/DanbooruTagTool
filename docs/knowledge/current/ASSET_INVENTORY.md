...
| runtime Prompt preprocessing / chunk / BREAK / weight | `../catalog/02_PROMPT_SUPPORT_AND_COMPOSITION.md` | `../research/BATCH_D_RUNTIME_PROMPT_REPRO_COMPOSITION_20260910.md` |
...
| generation effectiveness | Registry + `../catalog/02_*`, `03_*` | Batch A/B/C/D; WAI17 local baseline |
...
| relation | `../catalog/03_FAILURE_TESTING_AND_EVALUATION.md`, `../catalog/05_HARD_NICHE_ADULT_GENERATION.md` | Batch A; hard-domain research; Batch D external compositional benchmarks |
...
| compositional evaluation methodology | `../catalog/03_FAILURE_TESTING_AND_EVALUATION.md` | `../research/BATCH_D_RUNTIME_PROMPT_REPRO_COMPOSITION_20260910.md` (GenEval, T2I-CompBench) |
| reproducibility beyond seed | `../catalog/03_FAILURE_TESTING_AND_EVALUATION.md` | `../research/BATCH_D_RUNTIME_PROMPT_REPRO_COMPOSITION_20260910.md` |
...
| research papers | `../catalog/03_FAILURE_TESTING_AND_EVALUATION.md`, `08_*` | `S-ILL-002`, `S-RESEARCH-001/002/003/004`, Batch D GenEval/T2I-CompBench |
...
| version-dependent knowledge | `VERSION_FRESHNESS_LEDGER.csv` | model catalog, source registry, WAI17 baseline, Batch D runtime boundary |
