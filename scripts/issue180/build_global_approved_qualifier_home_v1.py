...
SOURCES=[A/"ROOT_REVIEW_BATCH_A_SECOND_REVIEW_V1.csv",A/"BATCH_A_REMAINING_7_SECOND_REVIEW_V2.csv",A/"P1_P3_AUTHORITY_SECOND_REVIEW_V1.csv"]
...
def approved():
 ...
 for p in SOURCES:
  ...
  for r in csv.DictReader(p.open(encoding="utf-8-sig",newline="")):
   q=(r.get("qualifier") or "").strip().lower()
