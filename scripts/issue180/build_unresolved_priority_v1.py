...
def main():
 ...
 pc=Counter(r["priority"] for r in out); qc=Counter(r["final_qualifier"] for r in out if r["priority"]=="P1_FAMILY_AUTHORITY" and r["final_qualifier"])
 s={"unresolved_rows":len(out),"priority_counts":dict(pc),"top_ip_families":qc.most_common(100),
