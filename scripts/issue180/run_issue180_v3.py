...
def main() -> None:
    ...
    report = {"schema_version": 3, "source_manifest_sha256": hashlib.sha256((OUT / "source_manifest_v3.json").read_bytes()).hexdigest(),
              ...
              "open_closure_classification_counts": units["open_closure_classification_counts"],
              "open_closure_classification_rows": units["open_closure_classification_rows"],
              "closure_sweep_path": "docs/issue180/v3/reports/RESEARCH_UNIT_CLOSURE_SWEEP_V3.csv",
