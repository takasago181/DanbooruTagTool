...
RECOMPILE=["validate_research_scope_v2.py","validate_issue179_origin_handoff_v1.py","validate_autonomous_policy_v2.py","validate_authority_decisions_v2.py","compile_character_home_v2.py","validate_autonomous_completion_v2.py","build_user_review_v2.py"]
