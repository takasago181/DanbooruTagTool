...
def main():
    ...
    v2r=write_review(V2_REVIEW,v2,{'stripper':'SEXUAL'});v3r=write_review(V3_REVIEW,v3,{})
    ...
    for key in safe:
        ...
        row['sexual_intent']='NON_SEXUAL';row['review_status']='AUTO_HIGH_CONF';row['rule_id']='AUTO_NONSEX_LEARNED_RISK_EXCLUSION_V3';row['evidence']='924_REVIEW_EVIDENCE+V2_119_120+V3_24_24; conservative risk exclusions cage/stripper'
    ...
    expected_status={'AUTO_HIGH_CONF':14893,'HUMAN_REVIEWED':1068,'UNCLASSIFIED':15791}
    expected_classes={'CONTEXTUAL':189,'NON_SEXUAL':15187,'NULL':15791,'SEXUAL':585}
