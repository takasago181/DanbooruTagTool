...
OUT = Path('docs/issue118/remaining_cluster_inventory_v42')
...
def main() -> int:
    ...
    if len(rows)!=6239: raise SystemExit(f'expected 6239 remaining UNCLASSIFIED rows, got {len(rows)}')
    inventory=[]
