...
OUT = Path('docs/issue118/remaining_cluster_inventory_v36')
...
def main() -> int:
    ...
    if len(rows)!=6739: raise SystemExit(f'expected 6739 remaining UNCLASSIFIED rows, got {len(rows)}')
    inventory=[]
